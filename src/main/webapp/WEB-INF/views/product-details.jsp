						...
						<div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
							<div class="text-center">
								<div class="input-group mb-3"
									...
									<span class="input-group-text">數量:</span> <input type="number"
										id="quantity" name="quantity" min="1" max="${product.stock}"
										value="1" class="form-control" style="max-width: 100px;">
								</div>
								<button id="addToCartBtn" class="btn btn-outline-dark mt-auto">加入購物車</button>
							</div>
						</div>
					</div>
				</div>
